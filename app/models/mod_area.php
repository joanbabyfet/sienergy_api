...
class mod_area extends mod_model
{
    //主键
    ...
    //获取所有下级列表
    protected function get_options($pid = 0)
    {
        $ret = [];
        if(empty($pid)) return $ret;
        ...
        !empty($rows) and $ret = mod_array::one_array($rows,['id', 'name']);
